...
\begin{document}
    ...
    \begin{tcolorbox}
        ...
        \begin{minipage}{0.65\textwidth} % Name and Contact Info
            \name{Leonardo Porto}{Doutorando de Astronomia} % Name and Profession
            \vspace{2em}
        ...
        \begin{minipage}[t]{0.7\textwidth} % Main Panel (e.g. Education, Work Experience)
            \begin{tcolorbox}[grow to right by=0.75cm,height=0.8\textheight,colframe=white,colback=white]
                ...
                \section*{Perfil Profissional}
                    Graduado em astronomia pelo Observatório do Valongo (UFRJ), mestre pelo IAG-USP e doutorando pelo CBPF (RJ). 
		    ...
		    \education{Mestrado - Astronomia}{2026 - 2027 (atual)}{USP}{Mestrado em Astronomia pelo IAG - USP}
		    \education{Doutorado - Astronomia}{2028 - (atual)}{USP}{Doutorando em Astronomia pelo CBPF (RJ)}
